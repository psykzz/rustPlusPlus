...
async function setupGeneralSettings(client, instance, channel) {
    await client.messageSend(channel, {
        files: [new MessageAttachment('/app/src/resources/images/general_settings_logo.png')]
    });
    ...
    await client.messageSend(channel, {
        ...
        files: [new MessageAttachment('/app/src/resources/images/settings_logo.png')]
    });
...
async function setupNotificationSettings(client, instance, channel) {
    await client.messageSend(channel, {
        files: [new MessageAttachment('/app/src/resources/images/notification_settings_logo.png')]
    });
